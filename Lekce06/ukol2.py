...
"""
# P5
# Potrebujeme menit typ z db na typ pro klienta
def nahrazovani(slovnik,cokoliv):
    """Tato funkce vraci nahrazenou hodnotu byt."""
    return slovnik[cokoliv]
